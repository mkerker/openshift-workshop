...
Using the **New Project** button, create a new project. We will call it **consoleproject**. Replace by your username to make this project unique. Type in a **Display Name** and **Description** of your choice.

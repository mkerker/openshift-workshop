...
Using the **New Project** button, create a new project. We will call it **consoleproject**. Type in a **Display Name** and **Description** of your choice.
...
From the command line, change the project to the "consoleproject" using the following command:

````
 oc project consoleproject
````
